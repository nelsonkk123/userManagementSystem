  ...
  const columns: ColumnDef<any, any>[] = [
    {
      ...
      cell: ({ row }) => (
        <div>
          ...
          <div className="text-xs text-muted-foreground">{row.original.role_code}</div>
        </div>
      ),
    },
    {
    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-page-title font-bold text-foreground">权限管理</h1>
